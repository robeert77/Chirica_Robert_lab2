...
namespace Chirica_Robert_lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Chirica_Robert_lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Chirica_Robert_lab2Context context, string[] selectedCategories, Book bookToUpdate) 
        { 
